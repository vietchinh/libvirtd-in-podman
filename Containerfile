...
RUN sed -i "s/^#\?listen_tls/listen_tls/" /etc/libvirt/libvirtd.conf; \
    sed -i "s/^#\?#isten_tcp/listen_tcp/" /etc/libvirt/libvirtd.conf; \
    sed -i "s/^#\?#tls_port/tls_port/" /etc/libvirt/libvirtd.conf; \
    sed -i "s/^#\?#tcp_port/tcp_port/" /etc/libvirt/libvirtd.conf; \
    sed -i "s/^#\?#listen_addr = \"192.168.0.1\"/tls_port = \"127.0.0.1\"/" /etc/libvirt/libvirtd.conf
